...
// ExecutionContext -> Permite acessar informações da requisição, resposta e outros dados da execução
// Injectable -> Indica que a classe pode ser injetada pelo sistema de dependências
...
export class AuthGuard implements CanActivate{
    ...
    private extrairToken(request: Request): string | undefined {
        ...
        // Caso o Header não exista, retorna undefined
        if (!authHeader){
            return undefined;
        }
